...
#define ARITHOVERFLOW -2
#define ARITHUNDERFLOW -3
#define MULTOVERFLOW -5
#define MULTUNDERFLOW -6
#define DIVBYZERO -4
#define DIVUNDERFLOW -7
#define PRTSTACKEMPTY -8
#define PRTALLSTACKEMPTY -9
#define DUPUNDERFLOW -10
#define SWAPUNDERFLOW -11
